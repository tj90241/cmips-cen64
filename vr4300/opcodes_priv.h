...
#define LL VR4300_BUILD_OP(LL, LL_SC, INFO2(NEEDRS, LOAD))
...
#define SC VR4300_BUILD_OP(SC, LL_SC, INFO3(NEEDRS, NEEDRT, STORE))
...
#define TNE VR4300_BUILD_OP(TNE, TNE, INFO2(NEEDRS, NEEDRT))
